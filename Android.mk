...
include $(CLEAR_VARS)
LOCAL_MODULE := SongDifficultyChart
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -D"MOD_ID=\"SongDifficultyChart\"" -D"VERSION=\"0.1.0\"" -I"extern/libil2cpp/il2cpp/libil2cpp" -I"./shared" -I"./extern" -I"./extern/codegen/include" -DID='"SongDifficultyChart"'
